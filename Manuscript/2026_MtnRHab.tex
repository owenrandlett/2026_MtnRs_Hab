...
This demonstrates that Melatonin does not have a generalized effect on sensory processing or motor output (e.g. by simply inducing sleep \citealp{Hill2026, Gandhi2015_NEURON}). 
...
\textbf{B-F)} Same as A, but for the O-bend response componentes of: 
\\ \textbf{B} Latency,
\\ \textbf{C} maximum Bend Amplitude,
\\ \textbf{D} Duration of the movement, 
\\ \textbf{E} Displacement as a result of the movement, and
\\ \textbf{F} Reorientation achieved by the larvae.
}
